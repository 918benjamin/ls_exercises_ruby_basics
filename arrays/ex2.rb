...
# variable named my_pets, the print the contents of my_pets as a single 
# string, e.g.: "I have a pet fish and a pet lizard!"

# Make sure you use my_pets to get the words "fish" and "lizard" in that message.

my_pets = pets[2], pets[3] # Solution uses a range instead, pets[2..3]
